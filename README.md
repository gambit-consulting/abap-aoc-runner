...
Open the `Participant` entity preview in the service binding `ZUI_AOC_PARTICIPANT_O4`. Create a new entry with the year number you want to solve (e.g. `2025`) and your auth cookie for the AoC page (todo: add simple explanation how to retrieve cookie).
